        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <form
                            action="{{ route('EditedQuizDetail', ['courses' => $courses->Courses_Title, 'id' => $quiz->Quiz_Id, 'QuestionID' => $question->Question_Id]) }}"
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    @foreach ($option as $o)
                                    {{-- Input None --}}
                                    <input type="text" style="display: none" value="{{ $o->Option_Id }}" name="OptionID[]">
                                    {{--  --}}
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="example-text-input" class="form-control-label">Option
                                                    {{ $loop->iteration }}</label>
                                                <input class="form-control" type="text"
                                                    placeholder="Enter Option {{ $loop->iteration }}" name="Option[]" value="{{ $o->Option }}">
                                                @error('Option[]')
                                                    <div class="mb-3">
                                                        <p>{{ $message }}</p>
                                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " type="text" placeholder="Tell The Answere"
                                                name="Answere" value="{{ $answer->Answare }}">
                                            @error('Answere')
                                                <div class="mb-3">
                                                    <p>{{ $message }}</p>
                                                </div>
                            ...
                            <div class="d-flex justify-content-center">
                                <button class="btn bg-gradient-success mb-2 w-75"
