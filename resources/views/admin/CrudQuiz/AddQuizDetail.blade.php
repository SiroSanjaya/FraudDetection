        ...
        <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <form action="{{ route('AddedQuizDetail', ['courses' => $courses->Courses_Title]) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control " type="text" name="Courses" value="{{ $courses->Courses_Title }}" readonly>
                                            @error('Courses')
                                                <div class="mb-3">
                                                    <p>{{ $message }}</p>
                                                </div>
